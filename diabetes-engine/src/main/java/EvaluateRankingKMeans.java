 ...
 */
public class EvaluateRankingKMeans {
    private static Logger logger = LoggerFactory.getLogger(EvaluateRankingKMeans.class);
...
//        dbUtils.dropEvaluationExperiment();
        ...
        FileInputStream fi = new FileInputStream(new File("diabetes-engine/clustering_model_using_kmeans_ranking.ser"));
        ...
        for(File f : files){
            ...
            try(FileWriter fw = new FileWriter(
                    ProjectPropertiesGetter.getSingleton().getProperty("R.utilities") + "recommended_wk_kmeans.csv",
                    true);
                BufferedWriter bw = new BufferedWriter(fw);
