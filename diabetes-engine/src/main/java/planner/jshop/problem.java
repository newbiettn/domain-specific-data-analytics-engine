...

{
	...
	private static void createState0(State s)	{
		...
		s.add(new Predicate(19, 0, new TermList(TermConstant.getConstant(126), new TermList(new TermNumber(2.0), TermList.NIL))));
		...
		s.add(new Predicate(79, 0, new TermList(TermConstant.getConstant(128), new TermList(new TermNumber(19061.0), TermList.NIL))));
