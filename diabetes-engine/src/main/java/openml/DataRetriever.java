...
public class DataRetriever {
    ...
    public static void main (String[] args) throws Exception {
        ...
        String httpsURL = "https://www.openml.org/data/download/1/dataset_1_anneal.arff";
        TheKing_DownloadFileFromURL(httpsURL, "src/main/resources/openml/anneal");
