...
public class ClusteringUsingKMeans {
    private static Logger logger = LoggerFactory.getLogger(ClusteringUsingKMeans.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        KMeans km = dc.performKmean(normalizedMf);
        String clusteringModelFilePath = "diabetes-engine/clustering_model_using_kmeans_ranking.ser";
...
//        KMeans km = (KMeans) oi.readObject();
//        oi.close();
