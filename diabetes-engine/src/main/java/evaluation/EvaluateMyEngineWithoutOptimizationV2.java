...
public class EvaluateMyEngineWithoutOptimizationV2 {
    private static Logger logger = LoggerFactory.getLogger(EvaluateMyEngineWithoutOptimizationV2.class);
...
//        oi.close();
        ...
        String[] datasetNames = new String[]{"anneal", "audiology", "autos", "balance-scale",
                ...
                "letter", "lymph","segment",
                "sick", "sonar", "soybean", "vehicle",
                "vote", "vowel", "waveform-5000", "zoo", "primary-tumor", "splice", "mushroom"};
...
//                }
                ...
                logger.info(a + "/" + c);
                Map<String, Object> r = Trainer.getSingleton().executeWithoutOptimizationForEvaluation(
                        datasetName,
                        trainingFileUrl,
                        testFileUrl,
                        output,
