...
public class EvaluateMyEngineWithOptimizationV1 {
    private static Logger logger = LoggerFactory.getLogger(EvaluateMyEngineWithOptimizationV1.class);
...
//        dbUtils.dropEvaluationExperiment();
        ...
        String[] datasetNames = new String[]{"anneal", "audiology", "autos", "balance-scale",
                ...
                "lymph","mushroom", "primary-tumor", "segment",
        ...
        for(String datasetName : datasetNames) {
            ...
            for (int seed : seeds){
                ...
                logger.info(a + "/" + c);
                Map<String, Object> r = trainer.executeForEvaluation(
                        datasetName,
                        trainingFileUrl,
                        testFileUrl,
                        output,
