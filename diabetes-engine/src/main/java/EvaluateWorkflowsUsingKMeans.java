...
public class EvaluateWorkflowsUsingKMeans {
    private static Logger logger = LoggerFactory.getLogger(EvaluateWorkflowsUsingKMeans.class);
...
//        int[] seeds = new int[]{1};
        ...
        for(File f : files) {
            ...
            int cluster = km.predict(normalizedX);
